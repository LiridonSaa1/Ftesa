    ...
    <div className="flex h-full max-h-screen flex-col gap-2">
      <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
        <Link href="/" className="flex items-center gap-2 font-semibold">
          <img src={`${import.meta.env.BASE_URL.replace(/\/$/, "")}/logo.svg`} alt="Dasma Pro" className="h-8 w-auto" />
          <span className="font-serif text-xl tracking-wide text-foreground">Dasma Pro</span>
        </Link>
      </div>
      ...
      <div className="flex flex-col">
        <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6 md:hidden">
          ...
          <div className="w-full flex-1 flex justify-center">
             <Link href="/">
              <span className="font-serif text-xl tracking-wide font-semibold text-foreground">Dasma Pro</span>
             </Link>
          </div>
        </header>
