...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  sq: {
    ...
    // Contact Form
    "contact.badge": "FORMULAR KONTAKTI",
    "contact.title": "Keni Pyetje Apo dëshironi një Demoni?",
    "contact.subtitle": "Plotësoni formularin më poshtë dhe ekipi ynë do t'ju kontaktojë brenda pak minutave me të gjitha detajet.",
    "contact.info_title": "Informatat e Kontaktit",
    "contact.address": "Prishtinë 10000, Kosovë",
    "contact.working_hours": "E Hënë - E Shtunë: 08:00 - 20:00",
    "contact.name": "Emri dhe Mbiemri",
    "contact.name_placeholder": "n.sh. Agon Berisha",
    "contact.email": "Adresa Email",
    "contact.email_placeholder": "emri@shembull.com",
    "contact.phone": "Numri i Telefonit (WhatsApp)",
    "contact.phone_placeholder": "+383 44 123 456",
    "contact.event_type": "Lloji i Eventit",
    "contact.event_wedding": "Dasmë",
    "contact.event_engagement": "Fejesë",
    "contact.event_birthday": "Ditëlindje",
    "contact.event_corporate": "Event Korporativ / Konferencë",
    "contact.event_other": "Tjetër",
    "contact.message": "Mesazhi apo Pyetja Juaj",
    "contact.message_placeholder": "Përshkruani datën e parashikuar, numrin e mysafirëve apo ndonjë kërkesë të veçantë...",
    "contact.submit": "Dërgo Mesazhin",
    "contact.submitting": "Duke dërguar...",
    "contact.success_title": "Faleminderit!",
    "contact.success": "Mesazhi juaj u dërgua me sukses! Ekipi ynë do t'ju kontaktojë së shpejti.",
